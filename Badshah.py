...
logo = """
   salman baloch
   ▄︻̷̿┻̿═━一
   THE ANONYMOUS Silo Bhai TRICKER 
   THE LEGEND ℒℴνℯ
...
\033[1;96mGitHub  \033[1;93m: \033[1;92
\033[1;96mBlogger \033[1;93m: \033[1;92
\033[1;91m======================================="""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
\033[1;96mYouTube \033[1;93m: \033[1;92m
\033[1;96mGitHub  \033[1;93m: \033[1;92m
\033[1;96mpage \033[1;93m: \033[1;92m
\033[1;91m======================================="""
print " \x1b[1;93m============================================================="
CorrectUsername = "salman"
CorrectPassword = "amdad"
loop = 'true'
while (loop == 'true'):
